...
export const features = [
  ...
  },
  {
    ...
    description: 'No fingerprint scanners or special hardware needed. RH_Eletropasso uses the camera on any smartphone to verify employee identity at check-in, eliminating buddy punching and attendance fraud.',
    subFeatures: [
...
export const FEATURES: FeatureData[] = [
  {
    slug: 'attendance-tracking',
    title: 'Attendance Management',
    metaTitle: 'Attendance Tracking Software | RH_Eletropasso - Selfie & GPS Check-In',
    ...
    bg: 'bg-blue-50',
    border: 'border-blue-100',
    heroDescription: 'Eliminate buddy punching and manual timesheets. RH_Eletropasso uses selfie-based check-in with GPS tracking to ensure authentic, tamper-proof attendance records — all from a simple mobile interface.',
    sections: [
      {
      ...
      },
      {
        ...
        description: 'Different workplaces have different needs. RH_Eletropasso supports two attendance modes to accommodate various work environments and shift patterns.',
        bullets: [
  ...
  },
  {
    slug: 'leave-management',
    title: 'Leave Management',
    metaTitle: 'Leave Management System | RH_Eletropasso - Request, Approve & Track',
    ...
    bg: 'bg-emerald-50',
    border: 'border-emerald-100',
    heroDescription: 'From application to approval in seconds. RH_Eletropasso automates your entire leave process with configurable leave types, instant notifications, and real-time balance tracking.',
    sections: [
      {
  ...
  },
  {
    slug: 'performance-reviews',
    title: 'Performance Reviews',
    metaTitle: 'Performance Review Software | RH_Eletropasso - Structured Review Cycles',
    ...
    sections: [
      {
        ...
        description: 'RH_Eletropasso implements a three-stage review process that ensures comprehensive, fair evaluations with input from multiple perspectives.',
        bullets: [
      ...
      },
      {
        ...
        description: 'Performance reviews in RH_Eletropasso automatically pull in relevant data from attendance and leave records, giving reviewers a complete picture of employee performance.',
        bullets: [
  ...
  },
  {
    slug: 'gps-geofencing',
    title: 'GPS & Location Verification',
    metaTitle: 'GPS Attendance Tracking | RH_Eletropasso - Location Verified Check-In',
  ...
  },
  {
    slug: 'biometric-selfie-verification',
    title: 'Biometric Selfie Verification',
    metaTitle: 'Selfie-Based Attendance | RH_Eletropasso - Photo Verified Check-In',
    ...
    bg: 'bg-purple-50',
    border: 'border-purple-100',
    heroDescription: 'No fingerprint scanners. No hardware. Just a selfie. RH_Eletropasso uses the camera on any smartphone to verify employee identity at check-in, eliminating attendance fraud without expensive biometric equipment.',
    sections: [
      {
      ...
      },
      {
        ...
        description: 'Employee photos are treated as sensitive data. RH_Eletropasso ensures selfie data is stored securely and only accessible to authorized personnel.',
        bullets: [
  ...
  },
  {
    slug: 'employee-directory',
    title: 'Employee Directory',
    metaTitle: 'Employee Directory & HR Database | RH_Eletropasso - Centralized Team Management',
  ...
  },
  {
    slug: 'reports-analytics',
    title: 'Reports & Analytics',
    metaTitle: 'HR Reports & Analytics | RH_Eletropasso - Data-Driven HR Decisions',
