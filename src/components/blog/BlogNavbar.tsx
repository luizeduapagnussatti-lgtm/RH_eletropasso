...
const BlogNavbar: React.FC<BlogNavbarProps> = ({ onRegisterClick }) => {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <button onClick={goToBlog} className="text-sm font-semibold text-primary transition-colors">
                {t('blog')}
              </button>
              <button onClick={goToTutorials} className="text-sm font-semibold text-slate-600 hover:text-primary transition-colors">
                {t('guides')}
              </button>
            </div>
        ...
        {mobileOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 shadow-lg">
            <div className="px-4 py-4 space-y-1">
              ...
              <button onClick={goToBlog} className="flex items-center gap-2 w-full text-left px-4 py-3 text-sm font-semibold text-primary bg-primary/5 rounded-xl transition-colors">
                <BookOpen size={16} /> {t('blog')}
              </button>
              <button onClick={goToTutorials} className="flex items-center gap-2 w-full text-left px-4 py-3 text-sm font-semibold text-slate-600 hover:text-primary hover:bg-slate-50 rounded-xl transition-colors">
